...
import { ModificarAsignacionObraBrutaDto } from '../../dto';
import { ModificarAsignacionObraBrutaUseCase } from '../modificar-asignacion-obra-bruta.usecase';

describe('ModificarAsignacionObraBrutaUseCase', () => {
  let useCase: ModificarAsignacionObraBrutaUseCase;
  ...
  const dtoBase: ModificarAsignacionObraBrutaDto = {
  ...
  beforeEach(() => {
    ...
    useCase = new ModificarAsignacionObraBrutaUseCase(
      asignacionTareaRepositoryMock,
      tareaRepositoryMock,
      trabajadorRepositoryMock,
    );
  ...
  it('lanza BadRequestException si nueva tarea no es OBRA_BRUTA', async () => {
    asignacionTareaRepositoryMock.findById.mockResolvedValue(asignacionBase);
