...
import { ConsultarAsignacionObraFinaUseCase } from '../consultar-asignacion-obra-fina.usecase';

describe('ConsultarAsignacionObraFinaUseCase', () => {
  let useCase: ConsultarAsignacionObraFinaUseCase;
  let asignacionTareaRepositoryMock: jest.Mocked<AsignacionTareaRepository>;

  const dtoBase: ConsultarAsignacionObraFinaDto = {
  ...
  beforeEach(() => {
    ...
    useCase = new ConsultarAsignacionObraFinaUseCase(
      asignacionTareaRepositoryMock,
    );
  });
