...
interface TareaObraFinaFormProps {
  initialData?: TareaObraFina;
  onSubmit: (data: RegistrarTareaObraFinaDto | ModificarTareaObraFinaDto) => void;
  loading?: boolean;
  isEdit?: boolean;
}

export function TareaObraFinaForm({ initialData, onSubmit, loading, isEdit }: TareaObraFinaFormProps) {
  const [values, setValues] = useState({
    ...
    perfilRequerido: initialData?.perfilRequerido || 'VIDRIERO',
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    if (isEdit) {
      const dto: ModificarTareaObraFinaDto = {
        ...
        perfilRequerido: values.perfilRequerido as PerfilObraFina,
        estadoTarea: values.estadoTarea as EstadoTarea,
      };
      onSubmit(dto);
    } else {
      const dto: RegistrarTareaObraFinaDto = {
