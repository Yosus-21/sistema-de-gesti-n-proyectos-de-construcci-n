...
interface AsignacionObraFinaDetailCardProps {
  asignacion: AsignacionObraFina;
}

export function AsignacionObraFinaDetailCard({ asignacion }: AsignacionObraFinaDetailCardProps) {
